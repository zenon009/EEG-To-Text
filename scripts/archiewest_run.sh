#!/bin/bash
 ...
 python ../util/construct_dataset_mat_to_pickle_v1.py -t task3-TSR -v "v2" -d "/users/wrb15144/temp_data/osfstorage-archive/" -o "/users/wrb15144/temp_data/preprocessed_zuco_1/task3/" -m "archie-west"
