...
python3 ../util/construct_dataset_mat_to_pickle_v1.py -t task2-NR -v "v2" -d "/vol/bulkdata/wrb15144/encoder_decoder/osfstorage-archive/" -o "/vol/bulkdata/wrb15144/encoder_decoder/preprocessed_zuco_1/task2"
