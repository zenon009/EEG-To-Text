...
if __name__ == '__main__':
    ...
    if 'task1' in task_name:
        ...
        with open(args["dataset_path_task1"], 'r') as handle:
            whole_dataset_dicts.append(json.load(handle))
    if 'task2' in task_name:
        #dataset_path_task2 = './dataset/ZuCo/task2-NR/pickle/task2-NR-dataset.pickle'
        with open(args["dataset_path_task2"], 'rb') as handle:
            whole_dataset_dicts.append(json.load(handle))
    if 'task3' in task_name:
        #dataset_path_task3 = './dataset/ZuCo/task3-TSR/pickle/task3-TSR-dataset.pickle'
        with open(args["dataset_path_task3"], 'rb') as handle:
            whole_dataset_dicts.append(json.load(handle))
    ...
    # dev dataloader
    val_dataloader = DataLoader(dev_set, batch_size = 1, shuffle=False, num_workers=2)
    # dataloaders
